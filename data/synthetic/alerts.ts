...
export const ALERT_RECORDS: AlertRecord[] = [
  ...
  { alertId:"ALR-0005", date:"2023-10-15", alertType:"Country Risk", priority:"High", tier:"L1", originator:"Internal", beneficiary:"Volga Energy", countries:["US","RU"], hoursToReview:20, slaStatus:"met", disposition:"true_match", makerId:"MKR-002", checkerId:"CHK-001", lob:"GCB" },
  ...
  { alertId:"ALR-0008", date:"2023-10-25", alertType:"Name Match", priority:"Low", tier:"L3", originator:"Wealth", beneficiary:"Lagos Trust", countries:["US","NG"], hoursToReview:70, slaStatus:"met", disposition:"false_positive", makerId:"MKR-027", checkerId:"CHK-014", lob:"GWIM" },
  ...
  { alertId:"ALR-0017", date:"2023-11-15", alertType:"Name Match", priority:"High", tier:"L1", originator:"Corp", beneficiary:"Bristol Exports", countries:["US","GB"], hoursToReview:28, slaStatus:"breached", disposition:"false_positive", makerId:"MKR-012", checkerId:"CHK-004", lob:"GCB" },
  ...
  { alertId:"ALR-0020", date:"2023-11-26", alertType:"Name Match", priority:"High", tier:"L1", originator:"Securities", beneficiary:"Havana Trust", countries:["US","CU"], hoursToReview:14, slaStatus:"met", disposition:"true_match", makerId:"MKR-004", checkerId:"CHK-002", lob:"GCIB" },
  ...
  { alertId:"ALR-0026", date:"2023-12-18", alertType:"SDN Hit", priority:"High", tier:"L1", originator:"Merrill", beneficiary:"Pyongyang Trade", countries:["US","KP"], hoursToReview:11, slaStatus:"met", disposition:"true_match", makerId:"MKR-003", checkerId:"CHK-005", lob:"GTS" },
  ...
  { alertId:"ALR-0032", date:"2024-01-16", alertType:"Name Match", priority:"High", tier:"L1", originator:"Global", beneficiary:"Havana Holdings", countries:["US","CU"], hoursToReview:17, slaStatus:"met", disposition:"true_match", makerId:"MKR-004", checkerId:"CHK-002", lob:"GWIM" },
  ...
  { alertId:"ALR-0039", date:"2024-02-05", alertType:"SDN Hit", priority:"High", tier:"L1", originator:"Risk", beneficiary:"Moscow Partners", countries:["US","RU"], hoursToReview:25, slaStatus:"breached", disposition:"true_match", makerId:"MKR-003", checkerId:"CHK-001", lob:"GCIB" },
  ...
  { alertId:"ALR-0051", date:"2024-03-01", alertType:"Country Risk", priority:"High", tier:"L1", originator:"GCB", beneficiary:"Tehran Export", countries:["US","IR"], hoursToReview:18, slaStatus:"met", disposition:"true_match", makerId:"MKR-002", checkerId:"CHK-001", lob:"GCB" },
  ...
  { alertId:"ALR-0066", date:"2024-05-03", alertType:"Entity Screen", priority:"High", tier:"L1", originator:"GWIM", beneficiary:"Minsk Corp", countries:["US","BY"], hoursToReview:18, slaStatus:"met", disposition:"true_match", makerId:"MKR-009", checkerId:"CHK-002", lob:"GWIM" },
  ...
  { alertId:"ALR-0072", date:"2024-06-03", alertType:"SDN Hit", priority:"High", tier:"L1", originator:"Corp", beneficiary:"Tbilisi Export", countries:["US","GE"], hoursToReview:14, slaStatus:"met", disposition:"true_match", makerId:"MKR-003", checkerId:"CHK-001", lob:"GCB" },
  ...
  { alertId:"ALR-0075", date:"2024-06-22", alertType:"SDN Hit", priority:"High", tier:"L1", originator:"Securities", beneficiary:"Ural Resources", countries:["US","RU"], hoursToReview:17, slaStatus:"met", disposition:"true_match", makerId:"MKR-002", checkerId:"CHK-001", lob:"GCB" },
  ...
  { alertId:"ALR-0091", date:"2024-09-02", alertType:"Name Match", priority:"Medium", tier:"L1", originator:"GTS", beneficiary:"Tashkent Corp", countries:["US","UZ"], hoursToReview:23, slaStatus:"met", disposition:"false_positive", makerId:"MKR-014", checkerId:"CHK-008", lob:"GTS" },
  ...
  { alertId:"ALR-0096", date:"2024-10-01", alertType:"Name Match", priority:"High", tier:"L1", originator:"Corp", beneficiary:"Caracas Corp", countries:["US","VE"], hoursToReview:19, slaStatus:"met", disposition:"true_match", makerId:"MKR-005", checkerId:"CHK-004", lob:"GCB" },
  ...
  { alertId:"ALR-0103", date:"2024-10-22", alertType:"SDN Hit", priority:"High", tier:"L1", originator:"GCB", beneficiary:"Pyongyang Corp", countries:["US","KP"], hoursToReview:12, slaStatus:"met", disposition:"true_match", makerId:"MKR-002", checkerId:"CHK-002", lob:"GCB" },
  ...
  { alertId:"ALR-0115", date:"2024-12-24", alertType:"Transaction Monitor", priority:"Low", tier:"L3", originator:"GWIM", beneficiary:"Nairobi Corp", countries:["US","KE"], hoursToReview:70, slaStatus:"met", disposition:"false_positive", makerId:"MKR-027", checkerId:"CHK-016", lob:"GWIM" },
  ...
  { alertId:"ALR-0129", date:"2025-02-12", alertType:"Entity Screen", priority:"Low", tier:"L3", originator:"Wealth", beneficiary:"Lome Trust", countries:["US","TG"], hoursToReview:72, slaStatus:"met", disposition:"false_positive", makerId:"MKR-028", checkerId:"CHK-015", lob:"GWIM" },
  ...
  { alertId:"ALR-0143", date:"2025-05-06", alertType:"SDN Hit", priority:"High", tier:"L1", originator:"GCIB", beneficiary:"Havana Holdings", countries:["US","CU"], hoursToReview:13, slaStatus:"met", disposition:"true_match", makerId:"MKR-007", checkerId:"CHK-004", lob:"GCIB" },
  ...
  { alertId:"ALR-0154", date:"2025-07-28", alertType:"Name Match", priority:"Low", tier:"L3", originator:"Wealth", beneficiary:"Conakry Trust", countries:["US","GN"], hoursToReview:70, slaStatus:"met", disposition:"false_positive", makerId:"MKR-027", checkerId:"CHK-016", lob:"GWIM" },
  ...
  { alertId:"ALR-0167", date:"2025-10-27", alertType:"Country Risk", priority:"Low", tier:"L3", originator:"GTS", beneficiary:"Abidjan Trust", countries:["US","CI"], hoursToReview:71, slaStatus:"met", disposition:"false_positive", makerId:"MKR-030", checkerId:"CHK-019", lob:"GWIM" },
  ...
  // ── Jan–Mar 2026 ────────────────────────────────────────────
  { alertId:"ALR-0177", date:"2026-01-05", alertType:"SDN Hit", priority:"High", tier:"L1", originator:"Corp", beneficiary:"Pyongyang Corp", countries:["US","KP"], hoursToReview:12, slaStatus:"met", disposition:"true_match", makerId:"MKR-003", checkerId:"CHK-001", lob:"GCB" },
  ...
  { alertId:"ALR-0185", date:"2026-03-02", alertType:"Entity Screen", priority:"High", tier:"L2", originator:"Securities", beneficiary:"Minsk Holdings", countries:["US","BY"], hoursToReview:44, slaStatus:"met", disposition:"true_match", makerId:"MKR-011", checkerId:"CHK-010", lob:"GTS" },
  ...
  { alertId:"ALR-0196", date:"2026-03-11", alertType:"Entity Screen", priority:"High", tier:"L1", originator:"GCB", beneficiary:"Pyongyang Corp", countries:["US","KP"], hoursToReview:10, slaStatus:"met", disposition:"pending", makerId:"MKR-002", checkerId:"CHK-006", lob:"GCB" },
  ...
  { alertId:"ALR-0200", date:"2026-03-11", alertType:"Name Match", priority:"Low", tier:"L3", originator:"GWIM", beneficiary:"Abuja Trust", countries:["US","NG"], hoursToReview:6, slaStatus:"pending", disposition:"pending", makerId:"MKR-025", checkerId:"CHK-018", lob:"GWIM" },
];
